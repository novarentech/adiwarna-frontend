...
import { GetAllMaterialReceivingReportResponse } from "@/lib/material-receiving";
...
export async function GET(req: Request) {
    try {
        ...
        const res = await fetch(`${apiBaseUrl}/material-receiving-reports?per_page=${perPage}&page=${page}&search=${search}`, {
            headers: {
        ...
        // Parse response JSON
        const data: GetAllMaterialReceivingReportResponse = await res.json();
...
export async function POST(req: Request) {
    try {
        ...
        const res = await fetch(`${apiBaseUrl}/material-receiving-reports`, {
            method: "POST",
            headers: {
