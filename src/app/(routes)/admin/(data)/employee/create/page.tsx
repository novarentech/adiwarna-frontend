            ...
            <div className="bg-white border rounded-sm px-5 py-6 shadow-xs my-12 ">
                ...
                <form onSubmit={handleCreateEmployee} className="flex flex-col">
                    ...
                    <div className="flex flex-col space-y-1">
                        <label htmlFor="employee-no" className="font-bold">No <span className="text-red-500">*</span></label>
                        <div className="flex">
                            <input id="employee-no" required
                                value={employeeNo}
                                onChange={(e) => setEmployeeNo(e.target.value)} type="text" className="flex-1 border border-[#AAAAAA] rounded-sm h-9 px-2" placeholder="add employee number" />
                        </div>
                    </div>
                    {/* Name */}
