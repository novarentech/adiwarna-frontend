    ...
    return (
        <div className="w-full h-full px-8 py-4 bg-[#f4f6f9]">
            ...
            <div className="flex flex-row justify-between items-center space-x-2 mt-14">
                {/* title  */}
                <h1 className="text-3xl font-normal">Daftar Surat Jalan</h1>
                {/* create surat jalan */}
                <Link href={"/admin/surat-jalan/create"} className="bg-[#31C6D4] text-white px-5 h-12 flex justify-center items-center rounded-sm hover:contrast-75">
            ...
            <div className="bg-white mt-10 rounded-[10px] overflow-hidden shadow">
                <Table className="bg-[#FFFFFF] rounded-t-[10px]">
                    ...
                    <TableBody>
                        <TableRow>
                            <TableCell className="py-8">SJ/001/AWP/XII/2024</TableCell>
                            <TableCell>15/12/2024</TableCell>
                            <TableCell>PT. Indo Persada</TableCell>
                            <TableCell>WO/2024/123</TableCell>
                            <TableCell>B 1234 XYZ</TableCell>
