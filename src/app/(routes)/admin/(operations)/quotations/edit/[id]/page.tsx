...
export default function EditQuotationsPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const fillForm = (data: Quotation) => {
        ...
        setRowsAdiwarna(
            data.adiwarnas.map(a => ({
                details: a.adiwarna_description,
                id: a.id,
            }))
        );
    ...
    const handleUpdateQuotation = async (e: React.FormEvent) => {
        ...
        const payload: UpdateQuotationPayload = {
            ...
            ref_year: Number(formData.ref_year),
            ...
            adiwarnas: rowsAdiwarna.map(r => ({
                id: r.id !== undefined ? Number(r.id) : undefined,
                adiwarna_description: r.details
            })),

            clients: rowsClient.map(r => ({
                id: r.id !== undefined ? Number(r.id) : undefined,
                client_description: r.details
            })),
        };
    ...
    return (
        <div className="w-full h-full px-4 py-4 bg-[#f4f6f9]">
            <div className="flex flex-row items-center space-x-2 mt-2">
                ...
                <h1 className="text-3xl font-normal">Edit Quotations</h1>
            </div>

            <div className="bg-white border rounded-sm px-5 py-6 shadow-xs my-12">
                <form onSubmit={handleUpdateQuotation} className="flex flex-col">
