            ...
            <div className="bg-white mt-12">
                <div className="py-3 px-4 flex justify-between border rounded-t-sm">
                    ...
                    <form className="flex flex-row">
                        <input id="search-input" type="text" className="w-[250px] rounded-l-sm h-8 border my-auto px-2 placeholder:text-sm" placeholder="Search Work Assignment.." />
                    ...
                    <Table className="bg-[#f2f2f2]">
                        ...
                        <TableBody>
                            ...
                            <TableRow>
                                ...
                                <TableCell className="py-4"><p className="text-sm">1231/AWP-INS/2077</p></TableCell>
                                <TableCell className="font-medium">	213123/AWP-INS/JKT/11</TableCell>
                                <TableCell>	21 November 2025</TableCell>
                                <TableCell>PT. MHI</TableCell>
                                <TableCell className="">MHI Workshop - Daan Mogot</TableCell>
                                <TableCell className="text-center">
                                    <div className="bg-white w-fit flex space-x-3 items-center mx-auto">
                                        <Link href={"/admin/work-assignment/edit/1"}><MdEdit className="w-7 h-7" /></Link>
                                        <div><FaTrash className="w-5 h-5 text-red-500" /></div>
                                        <Link href={"/admin/work-assignment/print"}><IoMdEye className="w-7 h-7 text-[#31C6D4]" /></Link>
                                    </div>
                                </TableCell>
                            </TableRow>
