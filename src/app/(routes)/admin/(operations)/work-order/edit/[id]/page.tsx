...
type EditWorkOrderParams = Promise<{ id: string }>;

export default function EditWorkAssignmentPage({
    params,
}: {
    params: EditWorkOrderParams;
}) {
    ...
    const handleEditWorkAssignment = (e: React.FormEvent) => {
    ...
    return (
        <div className="w-full h-full px-4 py-4 bg-[#f4f6f9]">
            ...
            <div className="bg-white border rounded-sm px-5 py-6 shadow-xs my-12 ">
                {/* start form */}
                <form onSubmit={handleEditWorkAssignment} className="flex flex-col">
